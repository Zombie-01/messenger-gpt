        ...
        try {
          ...
          if (message.postback) {
            if (message.postback.payload === config.postbackGetStarted) {
              console.log("GET_STARTED clicked by:", senderId);
              ...
              console.log("Learn More clicked for:", message.postback.payload);
              await this.sendArtistBio(senderId, message.postback.payload);
            } else {
              // Handle other postback payloads (artist names)
              console.log("Postback payload:", message.postback.payload);
              await this.sendArtistBio(senderId, message.postback.payload);
            }
          }
          // Handle text messages from user
            ...
            console.log("Text message from", senderId, ":", userMessage);
